...
export function Navigation() {
  ...
  return <nav className="flex flex-wrap items-center gap-1 border-b border-slate-200 bg-white px-6 py-3">
    <Link to="/" className="mr-4 font-bold text-slate-900">Central de Campanhas</Link>
