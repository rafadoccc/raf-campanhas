...
As colunas Prisma DateTime existentes permanecem em UTC por convenção (PostgreSQL timestamp sem timezone); Prisma recebe objetos Date e a API devolve ISO com Z. Não foi aplicada migration nem deslocamento aos registros antigos.
